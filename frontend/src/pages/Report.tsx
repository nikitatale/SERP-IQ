        ...
        return (
            <div className="min-h-screen bg-background flex items-center justify-center">
                <div className="text-center bg-card border border-border rounded-2xl p-10">
                    ...
                    <Link to="/dashboard" className="bg-primary px-5 py-2.5 rounded-xl text-sm font-600 syne text-white inline-block" style={{ color: "var(--background)" }}>
                        Back to Dashboard
                    </Link>
                </div>
            </div>
        ...
        return (
            <div className="min-h-screen bg-background flex items-center justify-center">
                <div className="text-center bg-card border border-border rounded-2xl p-10">
                    ...
                    <Link to="/analyze" className="bg-primary px-5 py-2.5 rounded-xl text-sm font-600 syne text-white inline-block" style={{ color: "var(--background)" }}>
                        Try Again
                    </Link>
                </div>
            </div>
                ...
                <div className="mb-8">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                        <div className="flex-1 min-w-0">
                            <h1 className="text-2xl font-500 text-foreground truncate">{new URL(analysis.url).hostname}</h1>
                ...
                <div className="flex gap-1 mb-6 overflow-x-auto pb-1" style={{ animationDelay: "200ms" }}>
                    {tabs.map((tab) => (
                        <button
                            ...
                            className={`px-5 py-2.5 rounded-xl text-sm font-medium transition-all whitespace-nowrap ${activeTab === tab.id ? "bg-primary text-white" : "bg-card border border-border text-muted-foreground hover:text-foreground hover:bg-muted/50"}`}
                ...
                <div key={activeTab}>
                    {activeTab === "overview" && (
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div className="bg-card border border-border rounded-2xl p-6">
                                <h3 className="text-lg font-600 syne text-foreground mb-4 flex items-center gap-2">
                    ...
                    {activeTab === "meta" && (
                        <div className="bg-card border border-border rounded-2xl p-6 shadow-sm">
                            <h3 className="text-lg font-600 syne text-foreground mb-6 flex items-center gap-2">
                                ...
                                {[
                                    ...
                                    <div key={meta.label} className="bg-muted/50 border border-border rounded-xl p-4">
                                        <div className="flex items-center justify-between mb-1">
                                            <span className="text-sm font-500 text-foreground">{meta.label}</span>
                    ...
                    {activeTab === "content" && (
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            <div className="bg-card border border-border rounded-2xl p-6">
                                <h3 className="text-lg font-600 syne text-foreground mb-4">Content Stats</h3>
                                <div className="space-y-4">
                            ...
                            <div className="bg-card border border-border rounded-2xl p-6">
                                <h3 className="text-lg font-600 syne text-foreground mb-4">Heading Hierarchy</h3>
                                <div className="space-y-2">
                            ...
                            {analysis.issues.length > 0 ? (
                                <>
                                    ...
                                    <div className="flex items-center gap-3 mb-4 flex-wrap">
                                        ...
                                        <span className="severity-critical px-2.5 py-1 rounded-full text-xs font-600 syne">{criticalCount} Critical</span>
                                        <span className="severity-warning px-2.5 py-1 rounded-full text-xs font-600 syne">{warningCount} Warnings</span>
                                        <span className="severity-info px-2.5 py-1 rounded-full text-xs font-600 syne">{infoCount} Info</span>
                                    </div>
                                ...
                                <div className="bg-card border border-border rounded-2xl p-12 text-center">
                                    ...
                                    <h3 className="text-lg font-600 syne text-foreground mb-2">No Issues Found!</h3>
