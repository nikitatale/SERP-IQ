        ...
        return (
            <div className="min-h-screen bg-background flex items-center justify-center">
                <div className="text-center glass-strong rounded-2xl p-10">
                    ...
                    <Link to="/rank-tracker" className="bg-primary px-5 py-2.5 rounded-xl text-sm font-600 syne text-white mt-4 inline-block" style={{ color: "var(--background)" }}>
                ...
                <div className="flex gap-1 mb-6 overflow-x-auto pb-1" style={{ animationDelay: "200ms" }}>
                    {tabs.map((tab) => (
                        <button
                            ...
                            className={`px-5 py-2.5 rounded-xl text-sm font-medium transition-all whitespace-nowrap ${activeTab === tab.id ? "bg-primary text-white" : "glass text-muted-foreground hover:text-foreground hover:bg-muted/50"}`}
                            ...
                            {tracking.competitors.length > 0 && (
                                <div className="glass rounded-2xl p-6">
                                    <div className="flex items-center justify-between mb-4">
                                        <h3 className="text-lg font-600 syne text-foreground flex items-center gap-2">
                                        ...
                                        {tracking.competitors.slice(0, 3).map((comp, i) => (
                                            <div key={i} className="glass rounded-xl p-4 flex items-start gap-4">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <p className="text-sm font-500 text-foreground truncate">{comp.title || comp.domain}</p>
                                    ...
                                    {tracking.competitors.map((comp, i) => (
                                        <div key={i} className="glass rounded-xl p-4 hover:bg-muted/50 transition-all">
                                            <div className="flex items-start gap-4">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <p className="text-sm font-500 text-foreground">{comp.title || "Untitled"}</p>
