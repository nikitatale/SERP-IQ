...
import { Plus, RefreshCw, Trash2, TrendingUp, TrendingDown, Minus, ExternalLink, Clock, Loader2, X, Search, Globe, AlertCircle, Eye, EyeOff, Filter, ArrowUpDown, Lightbulb, Target } from "lucide-react";
        ...
        <div className="min-h-scree pt-16 md:pt-24 bg-background">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
                    <div>
                        <h1 className="text-2xl sm:text-3xl font-500 text-foreground">
                    ...
                    <button onClick={() => setShowAddModal(true)} className="bg-primary px-5 py-2.5 rounded-xl text-sm font-600 syne text-white hover:opacity-90 transition-opacity flex items-center gap-2 self-start" id="add-keyword-btn" style={{ color: "var(--background)" }}>
                        <Plus size={18} />
                        Track Keyword
                    </button>
                </div>
                ...
                {loading ? (
                    ...
                    <div className="glass rounded-2xl p-12 text-center">
                        ...
                        <h3 className="text-lg font-600 syne text-foreground mb-2">No keywords tracked yet</h3>
                        <p className="text-sm text-muted-foreground mb-6">Add your first keyword and URL to start tracking your Google rankings.</p>
                        <button onClick={() => setShowAddModal(true)} className="bg-primary px-5 py-2.5 rounded-xl text-sm font-600 syne text-white text-white">
                                ...
                                <div key={kw._id} className={`glass rounded-xl p-5 hover:bg-muted/50 transition-all ${!kw.active ? "opacity-50" : ""}`}>
                                    <div className="flex flex-col lg:flex-row lg:items-center gap-4">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <Link to={`/rank/${kw._id}`} className="text-base font-600 syne text-foreground hover:text-primary transition-colors block truncate">
                                                "{kw.keyword}"
                                            </Link>
                ...
                <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                    <div className="bg-background border border-border rounded-2xl p-6 w-full max-w-md">
                        ...
                        <form onSubmit={handleAdd} className="space-y-4">
                            <div>
                                <label htmlFor="modal-keyword" className="block text-sm font-500 text-foreground mb-1.5">
                                    Keyword
                                </label>
                            ...
                            <div>
                                <label htmlFor="modal-url" className="block text-sm font-500 text-foreground mb-1.5">
                                    Website URL
                                </label>
                                <div className="relative">
