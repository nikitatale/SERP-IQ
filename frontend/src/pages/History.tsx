        ...
        <div className="min-h-screen pt-20 bg-background">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
                    ...
                    <Link to="/analyze" className="btn-forge px-5 py-2.5 rounded-xl text-sm font-600 syne text-white hover:opacity-90 transition-opacity self-start" style={{ color: "var(--background)" }}>
                        New Analysis
                    </Link>
                </div>
                ...
                {loading ? (
                    ...
                    <div className="glass rounded-2xl p-12 text-center">
                        ...
                        <h3 className="text-lg syne font-600 text-foreground mb-2">{searchQuery ? "No matching analyses" : "No analyses yet"}</h3>
                        ...
                        {processedData.map((a) => (
                            <div key={a._id} className="glass rounded-xl p-4 sm:p-5 flex flex-col sm:flex-row items-start sm:items-center gap-4 hover:bg-muted/50 transition-all group">
                                ...
                                <div className="flex-1 min-w-0">
                                    <Link to={`/report/${a._id}`} className="text-sm font-500 text-foreground hover:text-primary transition-colors truncate block">
                                        {(() => {
                                            try {
